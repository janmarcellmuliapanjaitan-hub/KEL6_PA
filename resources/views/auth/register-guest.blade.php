<!-- resources/views/auth/register-guest.blade.php -->
<!DOCTYPE html>
<html lang="id">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Register Pelanggan - Janji Martahan Coffee</title>
...
<body>
    <div class="register-card">
        <div class="text-center mb-4">
            ...
            <h4 class="title mb-1">Daftar Akun Baru</h4>
            <p style="color: #c4a27a; font-size: 0.9rem;">Bergabunglah dengan pelanggan lainnya</p>
        </div>
        
        @if($errors->any())
            <div class="alert alert-danger" style="background: rgba(220,53,69,0.15); border: 1px solid rgba(220,53,69,0.3); color: #ff6b6b; border-radius: 8px; font-size: 0.9rem; padding: 10px 15px;">
                <ul class="mb-0 ps-3">
        ...
        <div class="text-center">
            <p class="mb-2" style="color: #c4a27a; font-size: 0.9rem;">
                Sudah punya akun? 
                <a href="{{ route('guest.login.form') }}" style="color: #e8c98a; font-weight: 500; text-decoration: none; border-bottom: 1px solid rgba(232,201,138,0.5); padding-bottom: 1px;">Login di sini</a>
            </p>
