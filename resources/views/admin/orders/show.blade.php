            ...
            <div class="card card-outline card-info">
                ...
                <div class="card-body">
                    <table class="table table-sm">
                        ...
                        <tr>
                            <th>WhatsApp</th>
                            <td><a href="https://wa.me/{{ $order->whatsapp_number }}"
                                    target="_blank">{{ $order->whatsapp_number }}</a></td>
                        </tr>
                        <tr>
                            <th>Tipe</th>
                    ...
                    <table class="table table-bordered">
                        ...
                        <tfoot>
                            <tr>
                                ...
                                <th class="text-right text-success" style="font-size:1.2rem;">Rp
                                    {{ number_format($order->total_price, 0, ',', '.') }}</th>
                            </tr>
                        </tfoot>
                    </table>
                </div>
